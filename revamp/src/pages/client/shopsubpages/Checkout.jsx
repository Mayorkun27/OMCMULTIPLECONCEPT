...
      address_line: Yup.string()
        .required("Address is required!."),
      // These are now simple required strings
      country: Yup.string()
        .required("Country is required!."),
      state: Yup.string()
        .required("State is required!."),
...
            {/* Postal Code Input */}
            <div className="flex flex-col gap-1 col-span-12 md:col-span-6">
              <label className="font-[Montserrat]! font-medium! text-dark/90" htmlFor="postal">Enter your postal code (Optional)</label>
              <input
                type='text'
                name="postal" 
                id="postal"
...
            <div className="flex flex-col gap-1 col-span-12 md:col-span-4">
              <label className="font-[Montserrat]! font-medium! text-dark/90" htmlFor="country">Enter your country</label>
              <input
                type="text"
                name="country" 
                id="country"
...
            {/* State Input (Manual) */}
            <div className="flex flex-col gap-1 col-span-12 md:col-span-4">
              <label className="font-[Montserrat]! font-medium! text-dark/90" htmlFor="state">Enter your state/region</label>
              <input
                type="text"
                name="state" 
                id="state"
...
            {/* City Input (Manual) */}
            <div className="flex flex-col gap-1 col-span-12 md:col-span-4">
              <label className="font-[Montserrat]! font-medium! text-dark/90" htmlFor="city">Enter your city</label>
              <input
                type="text"
                name="city" 
                id="city"
